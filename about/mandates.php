...
<div class="row gap-y-2">
  <div class="col-md-6">
    <div class="de-content-overlay rounded border border-secondary">
      <div class="box-icon">
        <span class="icon rounded-pill "><img src="../images/svg/mission.svg" alt=""></span>
        <div class="text">
          <h3 class="style-1">Mission</h3>
          <p style="font-size: 18px">We coordinate, integrate, fund, and manage the Research for Development (R4D) system to ensure its optimum utility for the agriculture and fisheries sector.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="col-md-6">
    <div class="de-content-overlay rounded border border-secondary">
      <div class="box-icon">
        <span class="icon rounded-pill "><img src="../images/svg/vision.svg" alt=""></span>
        <div class="text">
          <h3 class="style-1">Vision</h3>
          <p style="font-size: 18px">The lead Research for Development (R4D) coordinating agency towards a technology-empowered agriculture and fisheries sector contributory to inclusive growth.</p>
        </div>
      </div>
    </div>
  </div>
  <div class="col-md-12">
    ...
    <div class="de-content-overlay rounded border border-secondary">
      ...
      <div class="box-icon">
        <span class="icon rounded-pill "><img src="../images/svg/mandate.svg" alt=""></span>
        <div class="text">
