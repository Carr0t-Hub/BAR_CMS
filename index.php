  ...
  <div class="container-fluid">
    <div class="row g-0">
      <div class="col-md-4 p-3" data-bgcolor="rgba(0, 0, 0, .2)">
        <div class="info-box ">
          <img src="images/1.png" alt="" class="img-fluid" style="height: 96px; object-fit: contain">
        </div>
      </div>

      <div class="col-md-4 p-3" data-bgcolor="rgba(0, 0, 0, .4)">
        <div class="info-box ">
          <img src="images/2.png" alt="" class="img-fluid" style="height: 96px; object-fit: contain">
      ...
      <div class="col-md-4 p-3" data-bgcolor="rgba(0, 0, 0, .6)">
        <div class="info-box ">
          <img src="images/3.png" alt="" class="img-fluid" style="height: 96px; object-fit: contain">
