  ...
  <div class="row mb-2">
    <div class="col-lg-12">
      <div class="d-flex justify-content-between">
        <div>
          <h4>BFAR - Regional Offices</h4>
        </div>
        <div>
        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#bfarro"><i class="ri-file-add-line"></i> Add New</button>
        </div>
      </div>
    </div>
  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="d-grid gap-2">
                    <button class="btn btn-primary bfarroItem" type="button" name="editData" id="editData" data-id="<?= $value['id'] ?>"><i class="ri-edit-2-line"></i> Edit</button>
                  </div>
                </td>
              </tr>
            <?php endforeach; ?>
