  ...
  <div class="row mb-2">
    <div class="col-lg-12">
      <div class="d-flex justify-content-between">
        ...
        <div>
          <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#memo"><i class="ri-file-add-line"></i> Add New</button>
        </div>
      </div>
    </div>
  </div>
